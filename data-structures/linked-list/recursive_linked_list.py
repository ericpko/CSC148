...
class LinkedListRec:
    ...
    and the node-based implementation. Even though both classes
    have the same public interface, how they implement their
    ...
    def __len__(self) -> int:
        ...
        # or if you don't have a size attribute...
        # if self.is_empty():
        #     return 0
        # else:
    ...
    def count(self, item: object) -> int:
        ...
        if self.is_empty():
            ...
            return 1 + sum([self._rest.count(item)])
        else:
            return sum([self._rest.count(item)])
    ...
    def map(self, f: Callable[[object], object]) -> 'LinkedListRec':
        ...
        if self.is_empty():
            ...
            return LinkedListRec([f(self._first), f(self._rest._first)])
        else:
            return self._rest.map(f)
